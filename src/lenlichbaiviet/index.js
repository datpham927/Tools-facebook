...
async function scheduleVideos(driver, VIDEO, CAPTION) {
    ...
    let startDate = new Date("2025-03-20"); // Ngày bắt đầu đăng bài
    ...
    for (let i = 0; i < content.length; i++) {
        try {
            ...
            const scheduleHours = (currentDay === 0 || currentDay === 6) ? POST_SCHEDULE.weekend : POST_SCHEDULE.weekdays;
            ...
            console.log(`📅==== Đang lên lịch bài viết ${i + 1}: ${formattedDate} lúc ${targetHour}:00`);
